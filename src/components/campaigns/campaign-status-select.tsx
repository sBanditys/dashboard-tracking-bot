...
/**
 * Campaign status filter dropdown using Headless UI Listbox.
 * ARIA-compliant with keyboard navigation support.
 */
export function CampaignStatusSelect({ value, onChange, className }: CampaignStatusSelectProps) {
  ...
  return (
    <Listbox value={value} onChange={onChange}>
      <div className={cn('relative', className)}>
        <ListboxButton
          className={cn(
            'relative w-44 py-3 pl-3 pr-10 text-left',
