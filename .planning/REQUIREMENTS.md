...
- [x] **CAMP-01**: User can view paginated campaign list with cursor-based infinite scroll
- [x] **CAMP-02**: User can filter campaigns by status (Draft/Active/Paused/SubmissionsClosed/Completed)
- [x] **CAMP-03**: User can view campaign detail with summary counters (earned, participants, posts, budget remaining)
- [x] **CAMP-04**: User can see color-coded status badges on list and detail views
- [x] **CAMP-05**: Admin can create a campaign with name, budget, per-user cap, and platform rates
- [x] **CAMP-06**: Admin can edit campaign configuration (14 optional fields with 409 conflict handling)
- [x] **CAMP-07**: Admin can delete campaign (Draft/Completed only, with confirmation dialog)
- [x] **CAMP-08**: User can see platform rate cards with icons on campaign detail
- [x] **CAMP-09**: User can see budget utilization progress bar on campaign detail

### Campaign Analytics

- [x] **ANAL-01**: User can view cursor-paginated participant earnings table with post counts
- [x] **ANAL-02**: User can search participants by userId in the analytics/payouts view

### Campaign Payouts

- [x] **PAY-01**: User can view offset-paginated payout status list (paid/unpaid per participant)
- [x] **PAY-02**: Admin can mark a single participant as paid with confirmation dialog
- [x] **PAY-03**: Admin can bulk mark participants as paid (max 50, checkbox selection)
- [x] **PAY-04**: User can view offset-paginated payout history audit trail
- [x] **PAY-05**: Payout mutations use optimistic updates with rollback on error

### Campaign Export

- [x] **EXP-01**: Admin can trigger campaign export (CSV/XLSX) with scope selection (payment/full)
- [x] **EXP-02**: User can see export progress via SSE with download link on completion
...
|-------------|-------|--------|
| CAMP-01 | Phase 26 | Complete |
| CAMP-02 | Phase 26 | Complete |
| CAMP-03 | Phase 26 | Complete |
| CAMP-04 | Phase 26 | Complete |
| CAMP-05 | Phase 27 | Complete |
| CAMP-06 | Phase 27 | Complete |
| CAMP-07 | Phase 27 | Complete |
| CAMP-08 | Phase 26 | Complete |
| CAMP-09 | Phase 26 | Complete |
| ANAL-01 | Phase 28 | Complete |
| ANAL-02 | Phase 28 | Complete |
| PAY-01 | Phase 28 | Complete |
| PAY-02 | Phase 28 | Complete |
| PAY-03 | Phase 28 | Complete |
| PAY-04 | Phase 28 | Complete |
| PAY-05 | Phase 28 | Complete |
