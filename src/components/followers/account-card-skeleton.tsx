  ...
  return (
    <div className="bg-surface border border-border rounded-lg px-4 py-3">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-shrink-0 w-10 h-10 rounded-full bg-surface-hover animate-pulse" />

        {/* Username + platform skeleton */}
        <div className="flex-1 min-w-0 space-y-1.5">
          <div className="flex items-center gap-1.5">
            <div className="h-3.5 w-28 bg-surface-hover rounded animate-pulse" />
            <div className="h-3.5 w-7 bg-surface-hover rounded animate-pulse" />
          </div>
        </div>
        ...
        <div className="flex-shrink-0 text-right space-y-1">
          ...
          <div className="h-3 w-16 bg-surface-hover rounded animate-pulse ml-auto" />
        </div>

        {/* Sparkline skeleton */}
        <div className="flex-shrink-0 w-20 h-8 bg-surface-hover rounded animate-pulse" />
      </div>
    </div>
  )
}
